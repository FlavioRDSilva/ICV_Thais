...
namespace FayvitMove
{
    ...
    public class BasicMove
    {
        ...
        public bool UseRollSpeed { get; set; }

        private bool apGravity = true;
        public bool ApplicableGravity { get { return apGravity; } set { apGravity = value; } }

        public CharacterController Controller { get; private set; }

        public JumpManager _JumpM { get; private set; }

        public Transform LockTarget { get { return lockTarget; } set { lockTarget = value; } }

        private float modSpeed = 1;
        public float ModSpeed { get { return modSpeed; } set { modSpeed = value; } }
        public float WalkSpeed { get { return movFeatures.walkSpeed; } }
