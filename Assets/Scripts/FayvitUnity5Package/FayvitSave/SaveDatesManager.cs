...
namespace FayvitSave
{
    ...
    public class SaveDatesManager :  ISaveDatesManager
    {
        ...
        public List<PropriedadesDeSave> SaveProps { get { return saveProps; } set { saveProps = value; } }

        private List<SaveDates> savedGames = new List<SaveDates>();
        public List<SaveDates> SavedGames { get { return savedGames; } set { savedGames = value; } }

        private LanguageKey chosenLanguage = LanguageKey.pt_br;
        public LanguageKey ChosenLanguage { get { return chosenLanguage;  } set { chosenLanguage = value; } }
