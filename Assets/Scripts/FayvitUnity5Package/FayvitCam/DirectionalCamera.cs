...
namespace FayvitCam
{
    ...
    public class DirectionalCamera
    {
        ...
        private StateCam state = StateCam.controlable;
        public StateCam State { get { return state; } set { state = value; } }
        ...
        public float SphericalDistance {
            get { return features.sphericalDistance; }
            set {
                if (value >= 0)
        ...
        {
            get { return features.varVerticalHeightPoint; }
        ...
        public void SetFeatures(
            ...
            Quaternion camRotation = default(Quaternion))
        {
            features = car;
        ...
        public void SetPositionAndRotationToLerp(Vector3 dirViewCam = default(Vector3))
        {
            if (dirViewCam == default(Vector3))
                features.activeDir = features.mainDir;
            else
