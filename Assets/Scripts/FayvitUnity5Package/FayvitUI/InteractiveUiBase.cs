...
namespace FayvitUI
{
    public abstract class InteractiveUiBase
    {
        ...
        public virtual Transform GetTransformContainer { get { return menuScrollRect.transform.parent; } }
        ...
        public int SelectedOption { get { return selectedOption; } private set { selectedOption = value; } }
